...
import org.cheercode.after_review_version.factories.key_bet_help.KeyBetHelpFactory;
import org.cheercode.after_review_version.dialogs.StringDialogWithPredicate;
import org.cheercode.after_review_version.result_analyzers.BetResultAnalyzer;
...
public class Game {
    ...
    public Game(ScoreCounter scoreCounter, Deck deck, Render render, BetFactory betFactory) {
        this.possibleBetMessage = POSSIBLE_BET_TEMPLATE + KeyBetHelpFactory.get(betFactory);
